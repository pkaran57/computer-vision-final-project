...
def calc_iou(gt_bbox, pred_bbox):
    ...
    Args:
        gt_bbox (list of floats): list of locations of the ground truth objects as [xmin, ymin, xmax, ymax]
        pred_bbox (list of floats): list of locations of the predicted objects as [xmin, ymin, xmax, ymax]
    ...
    # For some models, the predicted bboxes are not correct. Hence the check...
...
def get_single_image_results(gt_boxes, pred_boxes, iou_thr=0.5):
    ...
    Args:
        ...
        pred_boxes (list of list of floats): list of locations of predicted
            objects as [xmin, ymin, xmax, ymax] (formatted like `gt_boxes`)
